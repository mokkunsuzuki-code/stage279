...
def build_summary_dict(repo_root: str, git_commit: str, git_branch: str, generated_at: str) -> dict:
    return {
        ...
        "artifact": {
            "summary_file": "out/stage279/summary.json",
            "sha256_file": "out/stage279/summary.sha256",
            "ots_file": "out/stage279/summary.json.ots",
            "manifest_file": "out/stage279/manifest.json",
        },
        "claim": {
...
def main() -> None:
    ...
    manifest = {
        ...
        "files": {
            "summary": {
                "path": "out/stage279/summary.json",
                "sha256": summary_digest,
            },
            "summary_sha256": {
                "path": "out/stage279/summary.sha256",
                "sha256": sha256_file(sha256_path),
            },
            "summary_ots": {
                "path": "out/stage279/summary.json.ots",
