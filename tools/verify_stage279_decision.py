...
def main() -> None:
    parser = argparse.ArgumentParser(description="Verify Stage279 decision reproducibility.")
    parser.add_argument(
        "--summary",
        default="out/stage279/evidence_summary.json",
        help="Path to evidence summary JSON"
    )
    parser.add_argument(
        "--decision",
        default="out/stage279/decision.json",
        help="Path to decision JSON"
    )
    parser.add_argument(
        "--sha256",
        default="out/stage279/decision.sha256",
